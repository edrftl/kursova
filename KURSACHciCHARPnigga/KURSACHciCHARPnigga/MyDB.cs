    ...
    class MyDB : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Room>().HasData(
                ...
                new Room { Id = 2, NameOfRoom = "Room 2", FirstRoomId = 1, SecondRoomId = 3, ThirdRoomId = 4 },
                ...
                new Room { Id = 18, NameOfRoom = "Room 18", FirstRoomId = 18, SecondRoomId = 18, ThirdRoomId = 18 }
            );
        }
